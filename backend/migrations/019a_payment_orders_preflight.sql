-- Precreate the complete payment_orders schema before 020_support_tickets.sql
-- adds its foreign key. Migration 092 remains idempotent for existing databases.
