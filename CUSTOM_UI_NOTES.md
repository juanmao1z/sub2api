...
- 当前目标镜像：`sub2api-custom:0.1.144-ui1`
- 当前定制基线：官方 `v0.1.144` + 本仓库自定义 `/recharge` 页面与 `usage-leaderboard` 自定义菜单入口
...
6. 打包到 `deploy-artifacts/`，例如 `deploy-artifacts/sub2api-custom-0.1.144-ui1-context.tar.gz`。
