...
- 当前升级目标镜像：`sub2api-custom:0.1.156-ui1`
- 当前回滚镜像：`sub2api-custom:0.1.155-ui9`
...
若新镜像上线后异常，把 `/opt/sub2api-deploy/docker-compose.override.yml` 的镜像改回上一个可用标签 `sub2api-custom:0.1.155-ui9`，或恢复本次部署前的 `bak-v0156-ui1` 备份，然后执行：
