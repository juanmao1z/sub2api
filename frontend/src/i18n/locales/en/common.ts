export default {
  ...
  support: {
    ...
    changeFilters: 'Try another search or adjust the status filter.',
    historyHint: 'Your tickets and conversations will appear here.',
    resetFilters: 'Clear filters',
    details: 'Ticket details',
    contactSupport: 'Contact support',
    createHint: 'Share the details so we can understand your issue and help.',
    refundHint: 'Link an order for refund assistance',
    suggestionHint: 'Report an issue or suggest an improvement',
    subjectPlaceholder: 'Summarize your issue in one sentence',
    orderPlaceholder: 'Enter the related order ID',
    descriptionPlaceholder: 'Describe the issue, when it happened, and what you have tried. Include any error messages that may help.',
    privacyHint: 'Please do not share passwords or complete API keys.',
    submitting: 'Submitting…',
    ...
    selectHint: 'Choose a ticket from your history to view the conversation, or create a new one.',
    emptyHint: 'Get help with an issue, request a refund, or share a suggestion by creating a ticket.',
