export default {
  ...
  support: {
    ...
    allTickets: '全部工单',
    ticketCount: '共 {count} 条',
    loadFailed: '加载失败，请重试',
    retry: '重新加载',
    noMatches: '没有匹配的工单',
    changeFilters: '试试其他关键词，或调整状态筛选。',
    historyHint: '你提交的工单和沟通记录会显示在这里。',
    resetFilters: '清除筛选',
    details: '工单详情',
    contactSupport: '联系支持',
    createHint: '请填写问题详情，便于我们了解情况并协助处理。',
    refundHint: '关联订单，提交退款问题',
    suggestionHint: '问题反馈与改进建议',
    subjectPlaceholder: '用一句话概括你的问题',
    orderPlaceholder: '填写需要处理的订单号',
    descriptionPlaceholder: '请描述遇到的问题、发生时间和已尝试的操作。提供错误提示有助于我们排查。',
    privacyHint: '请勿发送密码、完整 API 密钥等敏感信息。',
    submitting: '正在提交…',
    submitTicket: '提交工单',
    you: '我',
    originalMessage: '原始问题',
    team: '支持团队',
    sending: '正在发送…',
    closedHint: '此工单已关闭。如有其他问题，可以新建工单。',
    selectTicket: '选择一个工单',
    selectHint: '从左侧选择历史工单查看详情，或创建新工单与我们联系。',
    emptyHint: '遇到使用问题、需要退款或有改进建议时，都可以在这里提交工单。',
    created: '工单已提交',
    replySent: '回复已发送',
    closed: '工单已关闭',
