<template>
  <!-- Row 1: Core Stats -->
  <div v-if="!platformOnly" class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    <!-- Balance -->
    <div v-if="!isSimple" class="card dashboard-stat-card p-5">
    ...
    <!-- API Keys -->
    <div class="card dashboard-stat-card p-5">
      <div class="flex items-center gap-3">
  ...
  <div v-if="!isSimple && platformCards.length > 0" class="card dashboard-stat-card p-5">
...
const props = defineProps<{
  /** @brief Render only platform usage and quotas when embedded in the overview disclosure. */
