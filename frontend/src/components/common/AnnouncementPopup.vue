  ...
  <Teleport to="body">
    <Transition name="popup-fade">
      <div
        ...
        class="fixed inset-0 z-[120] flex items-start justify-center overflow-y-auto bg-black/50 p-4 pt-[8vh] backdrop-blur-md"
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-md border border-gray-200 bg-white shadow-xl ring-1 ring-black/5 dark:bg-dark-800 dark:ring-white/10"
          @click.stop
        >
          <!-- Header with warm gradient -->
          <div class="relative overflow-hidden border-b border-amber-100/80 bg-gray-50 px-8 py-6 dark:border-dark-700/50 dark:from-amber-900/20 dark:via-orange-900/10 dark:to-yellow-900/5">
            ...
            <div class="relative z-10">
              ...
              <div class="mb-3 flex items-center gap-2">
                ...
                <span class="inline-flex items-center gap-1.5 rounded-lg bg-gray-900 px-2.5 py-1 text-xs font-medium text-white shadow-none">
          ...
          <div class="border-t border-gray-100 bg-gray-50/50 px-8 py-5 dark:border-dark-700 dark:bg-dark-900/30">
            <div class="flex items-center justify-end">
              <button
                ...
                class="rounded-xl bg-gray-900 px-6 py-2.5 text-sm font-medium text-white shadow-none transition-all hover:bg-gray-700"
              >
